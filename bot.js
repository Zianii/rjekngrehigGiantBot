...
client.on('message',async message => {
  ...
  client.on('message',async message => {
    ...
    message.guild.createChannel(`Members Count : [ ${message.guild.members.size} ]` , 'voice').then(c => {
      ...
      setInterval(function() {
        c.setName(`Member Count : [ ${message.guild.members.size} ]`)
      },1000);
    });
    }
  });
 ...
 **❖ -mute => عطاءشخص ميوت** 
 **❖ -mutevoice => عطاءشخص ميوت صوتي** 
 **❖ -unmute => لفك ميوت عن شخص**
 **❖ -ban => حظر شخص من سيرفر**
 **❖ -kick => طرد شحص من سيرفر**
 **❖ -move => لسحب شخص **
 **❖ -moveall => لسحب جميع الاعضاء اليك **
 **❖ -clear => لمسح شات**
 **❖ -closeroom => لتقفيل روم**
 **❖ -openroom => لفتح روم**
 **❖ -createroom => لصنع روم** 
 **❖ -obc => ارسال برودكاست للاونلاين فقط**
 **❖ -bc => ارسال برودكاست للاونلاين و اوفلاين**
...
client.on('message', async najzx => {
    if(najzx.content.startsWith("-createroom")) {
